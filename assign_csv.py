...
t_prompt = 'Enter Team Projects by pairs, (default, none): format a b,c d\n'
teams = input(t_prompt).split(",")
AsmtsPerStudent = input("Enter assessments per student (default = 3):")
if teams == ['']:
    print(f"No teams were identified. Use ring assignment algorithm.")
    Teams = False
else:
    Teams = True
...
def print_asmts():
    ...
    # enumerate doesn't seem to work with items, do manually for now
    i = 1
...
# begin getting data and assigning assessments
